    ...
    tbfine(function () {
    	return {
    		...
    		init: function () {
    			...
    			tab = '<div class="smilie-tab pull-right"><a href="#smilie-tab-1" class="but" data-toggle="tab"><i class="fa fa-chevron-left" aria-hidden="true"></i></a><a class="but" href="#smilie-tab-2" data-toggle="tab"><i class="fa fa-chevron-right"></i></a></div>';
    			nr = '<div class="tab-content" style="min-height:338px"><div class="tab-pane fade in active" id="smilie-tab-1">' + _s1 + '</div><div class="tab-pane fade" id="smilie-tab-2">' + _s2 + '</div></div>';
