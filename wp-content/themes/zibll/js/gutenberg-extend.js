    ...
    $(document).ready(function () {
        ...
        rB('zibllblock/hide-ks', {
            ...
            edit: function (props) {
                ...
                }, '【 隐藏内容 起点 】', [isSelected && el('p', null, '以下内容蒋会被隐藏，评论后可见')], [isSelected && '这是起点，请注意添加：隐藏内容 - 终点！']);
            },
            save: function (props) {
                return '[reply]';
            },
        ...
        rB('zibllblock/hide-js', {
            ...
            edit: function (props) {
                ...
                }, [isSelected && '这是结束点，请检查是否添加：隐藏内容 - 起点！'], [isSelected && el('p', null, '以上内容蒋会被隐藏，评论后可见')], '【 隐藏内容 终点 】');
            },
            save: function (props) {
                return '[/reply]';
            },
