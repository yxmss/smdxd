...
function imgbox_open(e, b, c) {
	tbquire(['swiper'], function () {
		...
		_a.each(function () {
			...
			tupian += '<div class="swiper-slide"><div class="swiper-close no-scale"><div class="swiper-zoom-container"><img data-src="' + link2 + '" class="swiper-lazy lazyload"><div class="swiper-lazy-preloader"></div></div></div></div>';
		});
...
function click_imgbox(e) {
	$('body').on('click', e, function () {
		...
		link = $(this).attr("href") || $(this).attr("src");
		tupian = '<div class="swiper-slide"><div class="swiper-close no-scale"><div class="swiper-zoom-container"><img src="' + link + '"></div></div></div>';
		wrapper = '<div class="swiper-wrapper">' + tupian + '</div>';
