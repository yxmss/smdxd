...
<div class="wrap optionsframework">
    ...
    <div id="optionsframework-wrap">
        ...
        <h2 class="nav-page-title"><?php echo esc_html( $menu['page_title'] ); ?><span
                class="after"><?php $options_framework = new Options_Framework;$name = $options_framework->get_option_name(); echo strtoupper($name); ?></span>
        </h2>
