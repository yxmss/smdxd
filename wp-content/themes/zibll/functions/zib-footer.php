...
function zib_footer_con_2()
{
    ...
    if (!wp_is_mobile() || _pz('footer_mini_img_m_s', true)) {
        ...
        if (_pz('footer_contact_wechat_img')) {
            $html .= '<a id="fcode-popover-wechat" data-container="#fcode-popover-wechat" data-trigger="hover" data-placement="top" data-toggle="html-popover" data-target=".footer-wechat-img" href="javascript:;">' . zib_svg('d-wechat') . '</a>';

            $html .= '<div class="hide footer-wechat-img">';
            $html .= '<img class="lazyload" height="100" src="' . $s_src . '" data-src="' . _pz('footer_contact_wechat_img') . '">';
            $html .= '</div>';
        }
